-- Migration: Atomic Driver Approval RPC V2 (Cache Buster)
-- Date: 2026-02-10
-- Purpose: Same logic, new name to bypass schema cache issues

CREATE OR REPLACE FUNCTION public.approve_driver_application_v2(app_id UUID)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION public.approve_driver_application_v2(UUID) TO anon, authenticated, service_role;
