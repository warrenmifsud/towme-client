-- Migration: Schema Alignment & Active Drivers View Reconstruction
-- Date: 2026-02-10
-- Purpose: 
-- 1. Add financial columns to driver_applications (Source of Truth for Agreements).
-- 2. Reconstruct active_drivers view to join Applications (Financials) with Status (GPS).

-- 1. Add Financial Columns to Driver Applications
DO $$ BEGIN
...
COMMENT ON VIEW public.active_drivers IS 'Corrected View: Financials from Applications, GPS from Status.';
