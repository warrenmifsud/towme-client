-- TITAN-CLASS SCHEMA HARMONIZATION (V5.0) [cite: 2026-02-10]
-- MANDATE: ALIGNMENT WITH PHYSICAL REALITY (No rejected_at column)
...
BEGIN
    ...
    IF v_existing_status = 'REJECTED' OR v_existing_status = 'rejected' THEN
        ...
        SET 
            ...
            -- Reset Meta (Removed rejected_at as it does not exist)
