-- TITAN-CLASS SCHEMA HARMONIZATION (V3.0) [cite: 2026-02-10]
-- MANDATE: ZERO-TOLERANCE FOR FALSE TRUTHS
...
-- 2. DEPLOY SINGLE SOURCE OF TRUTH (PHYSICAL MAPPING)
...
BEGIN
    ...
    IF v_existing_status = 'REJECTED' OR v_existing_status = 'rejected' THEN
        ...
        SET 
            ...
            address = p_address,
            phone = p_phone,
            -- PHYSICAL COLUMN MAPPING (No tow_truck_ prefix)
            vehicle_type = p_tow_truck_type,
            vehicle_make = p_tow_truck_make,
            vehicle_model = p_tow_truck_model,
            vehicle_year = p_tow_truck_year,
            vehicle_color = p_tow_truck_color,
            license_plate = p_tow_truck_registration_plate,
            created_at = NOW(),
            -- Identity Updates
