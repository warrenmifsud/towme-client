...
export default function Home() {
    ...
    return (
        <div className="h-full flex-1 flex flex-col relative animate-fade-in overflow-hidden" style={{ backgroundColor: THEME.colors.appBg }}>
            {/* HEADER */}
            <header
                className="flex items-center justify-center p-6 relative z-20 shadow-none bg-white border-b border-slate-50"
            >
                {/* Centered Circular Logo: Midnight Blue (#1A1C2E) */}
                {/* Centered Circular Logo: Midnight Blue (#1A1C2E) */}
                <div className="w-16 h-16 rounded-full bg-[#1A1C2E] flex items-center justify-center shadow-md">
                    <span className="text-white font-bold text-xs tracking-widest">TOW<span className="text-[#F9A825]">ME</span></span>
                </div>
            ...
            <main className="flex-1 flex flex-col relative z-20 p-6">
                ...
                {
                    viewMode === 'MAP' && (
                        <div className="absolute inset-0 z-50 animate-slide-up" style={{ backgroundColor: THEME.colors.appBg }}>
                            <ServiceSelection
